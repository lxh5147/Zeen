...
public class IndexBuilder {
    ...
    private final List<FingerprintRepositoryInfo> fingerprintRepositoryInfoList;
	...
	// build CLI
	// -r --articleRepositories path1,path2,...pathn
	...
	IndexBuilder indexBuilder = new IndexBuilder(articleRepository,
